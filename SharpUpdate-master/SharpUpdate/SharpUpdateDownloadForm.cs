...
namespace SharpUpdate
{
    ...
    internal partial class SharpUpdateDownloadForm : Form
    {
        ...
        /// <summary>
        /// Creates a new SharpUpdateDownloadForm 原有包含MD5加密
        /// </summary>
        ...
        private void webClient_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                // Start the hashing // MD5加密，原有
                //bgWorker.RunWorkerAsync(new string[] { this.TempFilePath, this.md5 });
                //不用MD5加密,自己测试
                bgWorker.RunWorkerAsync(new string[] { this.TempFilePath});
        ...
        private void bgWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            // Hash the file and compare to the hash in the update xml //原有MD5加密，后面再看，测试取消MD5加密
